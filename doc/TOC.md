...
the [what's new in 2.1.0](whats-new.md#v2.1.0) documentation to learn about all the newer features in 2.1.0.
...
- Version History
   - v2.1.0 (released 2026-04-06) feature update ([see what's new in 2.1.0](whats-new.md#v2.1.0))
   ...
   - v1.0 (released 2021-12-11) Initial public release ([original documentation](https://github.com/neononane/Zelda1RandoTools/blob/v1.0/doc/TOC.md)) 
