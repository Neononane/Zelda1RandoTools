# Version 2.0.2 Beta Guide

The main feature of the Version 2.0.2 Beta release of ZTracker is the introduction of co-op synchronization between consoles. The intent is for one user to update data within their ZTracker console and see that same update propogate to another player's console. 
...
This current version synchronizes Triforces, Dungeon Items, Overworld Items, Overworld Locations, and current state of Gannon and Zelda completion. When one user has saved Zelda it will complete the Tracker for both users. 

Currently Dungeon Maps are not synchronized. 
...
* SyncUpdate Endpoint
 * The endpoint for the hosted SyncUpdate endpoint. This should be set to **/api/SyncUpdate**

* Negotiate Endpoint
 * The endpoint for the hosted Negotiate endpoint. This should be set to **/api/Negotiate**
...
Once Co-op Settings are updated begin ising the console as expected and snchronization should occur. 

Of note: all Co-op Settings will be saves to the settings file except Drbug Logging. This means coop being enabled will be the default on next launch.

**Known Issues/Limitations**

* Dungeon Maps do not synchronize
